...
@Component({
  selector: 'app-list-stagiere-applied',
  templateUrl: './list-stagiere-applied.component.html',
  styleUrls: ['./list-stagiere-applied.component.scss']
})
export class ListStagiereAppliedComponent implements OnInit {
    ...
    constructor(
      ...
      ,private DemandeServ:DemandeService,
          ...
          this.stagiereServ.getStagiereById(this.authService.userId).subscribe(elem=>
            ...
            this.DemandeServ.getOffreApplied(this.authService.userId).subscribe((elem)=>
            {
              console.log(elem)
              this.offres=elem;
            }
